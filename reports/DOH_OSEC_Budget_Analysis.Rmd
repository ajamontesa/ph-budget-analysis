...
## The ten largest P/A/Ps (FY 2027 NEP, proposed)
...
### The FY 2027 proposal in context: every P/A/P (interactive) {.unnumbered}
...
## What the FY 2027 proposal changes {#nep-change}
...
```{r fig-nep-change, fig.height=5.2}
nep_change <- pap_year %>%
