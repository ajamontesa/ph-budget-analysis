...
**Absorption has improved steadily.** Disbursement-to-allotment held at 71–84% through 2018–2023, then jumped to **90% (2024) and 96% (2025)** — the strongest readings on record, and a marked contrast to the capital-outlay struggles seen at health and education.
...
DSWD's expense-class profile is the most lopsided of any agency in this series: it is a MOOE department, because cash assistance is classified as an operating expense.
...
DSWD's absorption story is one of steady improvement — the opposite of the deteriorating capital-outlay pictures at health and education.
...
Because MOOE is 93–95% of the budget, the MOOE line here is essentially the aggregate line — the agency-wide absorption rate *is* the MOOE absorption rate. That is the mirror image of education and health, where the aggregate was dominated by a near-perfect Personnel Services block that masked weaker non-salary execution. At DSWD there is no large salary block to flatter the average; the headline number reflects how well the cash actually goes out the door.
...
The pattern echoes the other agencies: routine cash-transfer execution runs cleanly, while administrative and project-type lines lag. But the spread is far narrower than at health or education — the weakest material absorbers here sit around 40–57%, not the single digits seen elsewhere.
