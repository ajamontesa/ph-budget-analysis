...
**Scope.** The main analysis is **DSWD Office of the Secretary only**; the attached agencies (the National Anti-Poverty Commission, the Council for the Welfare of Children, and others) are summarised in a short **[attached-agencies section](#attached)** at the end. **Current New Appropriations only**; nominal pesos.
...
### Full P/A/P ranking, FY 2027 proposal (interactive) {.unnumbered}
...
```{r fig-nep-change, fig.height=4.8}
nep_change <- pap_year %>%
...
## In focus: the 4Ps proposal steps down {#four-ps}
...
# Line-item reference: the FY 2027 proposal in context {#reference}

The top 20 P/A/Ps by the FY 2027 proposal (NEP), with the FY 2026 proposal and enacted budget and the most recent (2025) disbursement-to-allotment ratio, so budget levels sit beside how each line has recently absorbed. The full unabridged list is in [the ranking section above](#full-pap-ranking-fy-2027-proposal-interactive).
...
# The attached agencies {#attached}
