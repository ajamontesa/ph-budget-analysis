...
**Locally-funded and foreign-assisted projects grow to over half the OSEC.** Grouped together they rise **+₱5.3B to ₱76.9B — 50.6% of the entire OSEC budget.** This category bundles many individual projects — often small and short-lived — and, as a group, absorbs slowly: disbursement-to-allotment was just **33% (2024) and 53% (2025)**.

**That is the central risk.** The fastest-growing, largest category is also the **weakest-absorbing and least-transparent** one — so the FY 2027 proposal tilts DA further toward money it has historically struggled to spend.
...
1. **A smaller budget, tilted toward the weakest absorber.** The FY 2027 NEP cuts DA ~8% while growing the Locally-Funded/Foreign-Assisted portfolio past **half the OSEC budget (₱76.9B)** — a category that disbursed just 33% (2024) and 53% (2025). What will make it spend faster as it grows, and should the line be disaggregated in the GAA so its sub-projects are visible?
