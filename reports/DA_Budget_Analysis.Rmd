...
It is the long-form companion to the DA briefing deck — and the most expanded of the set. The deck necessarily treats DA's operational core as a handful of headline lines; this version opens that core up. In addition to the standard analysis, it adds three deep-dives the slide format could not carry:
...
**Aggregate absorption has weakened as the budget grew.** Disbursement-to-allotment ran 74–81% from 2018 to 2023, then fell to **70% (2024) and 69% (2025)** — the lowest in the series. The LFP/FAP line, proposed at ₱71.6B for 2026 (≈6× its 2025 GAA) against recent absorption near 50%, is the central delivery risk.
...
Congress stayed within about ₱5B of the Executive's proposal in most years — sometimes trimming (2022, 2023, 2025), sometimes adding. The exception is the proposed **FY 2026 +₱31B Congressional add**, the largest in the series, concentrated in the two mega-lines.
