...
DAR is the smallest department in this series, and its budget tells a story the larger agencies do not. For eight straight years it was almost perfectly flat at ₱8–10B; then the 2026 proposal jumps 62% to ₱16.8B. Two features make DAR distinctive. First, **Congress has been a net *subtractor*** here — repeatedly trimming the Executive's proposal rather than augmenting it, the reverse of the pattern at health and social welfare. Second, the agency runs on two very different kinds of money: **routine, domestically-run programs that absorb beautifully (94–99%)**, and **foreign-assisted loan projects that absorb badly (19–38%)**. The 2026 surge is built almost entirely on the second kind — which means the budget is being loaded with precisely the program type DAR has the weakest record of spending.

# Executive summary {#exec}

**DAR is one of the smallest line departments.** The OSEC budget held at ₱8–10B for eight straight years (2018–2025), then jumps to a proposed ₱16.8B in 2026 — a 62% increase in a single year.
...
The clearest break from the other agencies is the direction of Congressional adjustment. The table pairs each year's GAA growth with the net change against the Executive's NEP — and that change is *negative* in several years.
...
In FY 2022 and FY 2023 the enacted GAA came in ₱2.4B and ₱4.5B below the Executive's proposal — almost entirely by cutting the SPLIT land-titling project. This is the opposite of the dynamic at DOH or DSWD, where Congress consistently *adds*. At DAR, the legislature has repeatedly judged the proposal too large to spend, and trimmed it.
