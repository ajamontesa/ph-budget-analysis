...
DENR stands apart from the other departments in this series in one fundamental way: **its budget has not grown.** While health, education, agriculture, and social welfare scaled up over 2018–2026, DENR-OSEC has been held almost perfectly flat in nominal terms at ₱16–19B — which, against the inflation of the period, is a real-terms *cut*. Three further features define it: Congress is a **net subtractor**, trimming the proposal in most years and cutting **forestry** hardest of all; **administration is the single largest line** in the budget; and the department has been **shedding capital spending** (down from 37% of the budget to 12%) in favour of payroll. The result is an environment department doing relatively less on-the-ground work, on a budget that has effectively shrunk, even as its mandate — climate resilience, Manila Bay, biodiversity, mining oversight — has expanded.

# Executive summary {#exec}

**DENR-OSEC's budget has been frozen.** The enacted GAA has held at ₱16–20B for nine straight years — ₱19.4B in 2018, ₱19.3B in 2026 — making DENR one of the few line departments not to scale up. **2018 remains the peak.** In nominal terms that is near-zero growth; adjusting for inflation, the FY 2026 budget is worth roughly **₱13.6B in 2018 pesos — about 30% below where the department started the period**.
...
ggplot(evo, aes(year, total, color = metric, group = metric)) +
  ...
  labs(title = "DENR-OSEC budget, NEP through Disbursements (FY 2018–2026)",
       subtitle = "Held almost perfectly flat at PHP 16–19B for nine years — while peers grew",
