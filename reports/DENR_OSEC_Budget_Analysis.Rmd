...
**Scope.** The main analysis is **DENR Office of the Secretary only**; the attached bureaus (EMB, MGB, NAMRIA, NWRB, PCSDS) are summarised in a short **[attached-agencies section](#attached)** at the end. **Current New Appropriations only**; nominal pesos unless a real (2018-constant) figure is named.
...
## The largest P/A/Ps (FY 2027 NEP, proposed)
...
```{r fig-nep-change, fig.height=3.6}
