...
## The budget per Muslim Filipino
...
1. **Is the envelope big enough?** NCMF's FY 2026 budget works out to roughly **₱188 per Muslim Filipino per year** — about fifty centavos a day — and closer to **₱110** if the community is as large as NCMF itself estimates. Does that match the scale of the mandate?
2. **Are Hajj services meeting what pilgrims actually need?** Hajj operations receive ₱104M in 2026. Is that enough for accreditation and oversight of organizers, welfare and medical support, and protection against illegal recruitment — and what do pilgrims themselves experience?
3. **Is Madrasah education keeping up?** Institutional support for Madrasah education, Shari'ah and Qur'an programs is ₱142M. Does that meet the demand for quality Islamic and Arabic-language education among Muslim Filipino learners?
4. **Are the livelihood programs scaled to need?** Endowment, Muslim MSEs and Halal together are about **5% of the budget (~₱62M)**. Halal certification in particular is a growing economic opportunity. Should these grow — and should they grow *alongside* cultural and religious services rather than out of them?
5. **Does the spending reach every community?** Half the budget sits in one undifferentiated line. Can communities see which centers, regions and activities it funds — including those far from the traditional centers, and Muslim Filipinos living outside Mindanao?
6. **What is missing entirely?** Which needs of Muslim Filipino communities does this budget simply not address?
7. **What would program-level execution data show?** With no FAR No. 1, we can see that NCMF spends what it is given overall, but not *which* programs lag. Program-level records would show whether the cultural, education and livelihood lines are delivering at the same rate.
